...
from .views import (
    ...
    bulk_upload_academic_records_view,
    ...
    student_achievement_detail_view,
    calculate_student_attendance_view,
    permissions_view,
...
urlpatterns = [
    ...
    path('bulk-upload-academic-records/', bulk_upload_academic_records_view),
    ...
    path('students/<int:student_id>/calculate-attendance/', calculate_student_attendance_view),
    ...
    path('students/<int:student_id>/career/', student_career_info_view),
    ...
    path('students/<int:student_id>/achievements/', student_achievements_view),
    path('students/<int:student_id>/achievements/<int:achievement_id>/', student_achievement_detail_view),
